...
| **SECURITY_SMELL** | Security Smell | **CRITICAL** | `+30` | Insecure patterns (e.g., `eval()`, `dangerouslySetInnerHTML`, hardcoded secrets). |
...
| **FRAMEWORK_ANTI** | Framework Anti-Pat | **WARNING** | `+15` | Misuse of framework-specific patterns (e.g., redundant `useEffect`, non-ESM Node.js). |
